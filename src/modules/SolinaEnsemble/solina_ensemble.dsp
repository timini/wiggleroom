// Solina Ensemble - Classic String Ensemble Effect
// Recreates the ARP Solina (1974) tri-phase BBD chorus
// Transforms thin waveforms into massive orchestral strings

import("stdfaust.lib");

declare name "Solina Ensemble";
...
// Depth: Modulation intensity (original Solina was fixed, we make it variable)
...
// Rate: Speed scaling (1.0 = original Solina speed)
...
// The Solina used two LFOs mixed together:
// Slow (Chorus): ~0.6 Hz
// Fast (Vibrato): ~6.0 Hz

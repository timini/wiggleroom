...
#include "analog_drums.hpp"  // Generated by Faust
...
/**
 * AnalogDrums - Virtual Analog Drum Machine
 *
 ...
 */
struct AnalogDrums : FaustModule<VCVRackDSP> {
...
struct AnalogDrumsWidget : ModuleWidget {
    AnalogDrumsWidget(AnalogDrums* module) {
        setModule(module);
        box.size = Vec(26 * RACK_GRID_WIDTH, RACK_GRID_HEIGHT);
        addChild(new WiggleRoom::ImagePanel(
            asset::plugin(pluginInstance, "res/AnalogDrums.png"), box.size));
        ...
        // === BASS DRUM (row 0) ===
        float y = startY;
        addInput(createInputCentered<PJ301MPort>(mm2px(Vec(colTrigIn, y)), module, AnalogDrums::BD_TRIG_INPUT));
        addParam(createParamCentered<Trimpot>(mm2px(Vec(colTune, y)), module, AnalogDrums::BD_TUNE_PARAM));
        addParam(createParamCentered<Trimpot>(mm2px(Vec(colParam1, y)), module, AnalogDrums::BD_DECAY_PARAM));
        addParam(createParamCentered<Trimpot>(mm2px(Vec(colParam2, y)), module, AnalogDrums::BD_TONE_PARAM));
        addParam(createParamCentered<Trimpot>(mm2px(Vec(colParam3, y)), module, AnalogDrums::BD_CLICK_PARAM));
        addChild(createLightCentered<SmallLight<RedLight>>(mm2px(Vec(colLed, y)), module, AnalogDrums::BD_LIGHT));
        addInput(createInputCentered<PJ301MPort>(mm2px(Vec(colTuneCV, y)), module, AnalogDrums::BD_TUNE_CV_INPUT));
        addOutput(createOutputCentered<PJ301MPort>(mm2px(Vec(colOut, y)), module, AnalogDrums::BD_OUTPUT));
        addInput(createInputCentered<PJ301MPort>(mm2px(Vec(colParamCV1, y)), module, AnalogDrums::BD_DECAY_CV_INPUT));
        addParam(createParamCentered<Trimpot>(mm2px(Vec(colParamCV2, y)), module, AnalogDrums::BD_LONG_DECAY_PARAM));

        // === SNARE DRUM (row 1) ===
        y = startY + rowHeight;
        addInput(createInputCentered<PJ301MPort>(mm2px(Vec(colTrigIn, y)), module, AnalogDrums::SD_TRIG_INPUT));
        addParam(createParamCentered<Trimpot>(mm2px(Vec(colTune, y)), module, AnalogDrums::SD_TUNE_PARAM));
        addParam(createParamCentered<Trimpot>(mm2px(Vec(colParam1, y)), module, AnalogDrums::SD_SNAPPY_PARAM));
        addParam(createParamCentered<Trimpot>(mm2px(Vec(colParam2, y)), module, AnalogDrums::SD_TONE_PARAM));
        addParam(createParamCentered<Trimpot>(mm2px(Vec(colParam3, y)), module, AnalogDrums::SD_SNAP_DECAY_PARAM));
        addChild(createLightCentered<SmallLight<RedLight>>(mm2px(Vec(colLed, y)), module, AnalogDrums::SD_LIGHT));
        addInput(createInputCentered<PJ301MPort>(mm2px(Vec(colTuneCV, y)), module, AnalogDrums::SD_TUNE_CV_INPUT));
        addOutput(createOutputCentered<PJ301MPort>(mm2px(Vec(colOut, y)), module, AnalogDrums::SD_OUTPUT));
        addInput(createInputCentered<PJ301MPort>(mm2px(Vec(colParamCV1, y)), module, AnalogDrums::SD_SNAPPY_CV_INPUT));
        addParam(createParamCentered<Trimpot>(mm2px(Vec(colParamCV2, y)), module, AnalogDrums::SD_DETUNE_PARAM));

        // === LOW TOM (row 2) ===
        y = startY + rowHeight * 2;
        addInput(createInputCentered<PJ301MPort>(mm2px(Vec(colTrigIn, y)), module, AnalogDrums::LT_TRIG_INPUT));
        addParam(createParamCentered<Trimpot>(mm2px(Vec(colTune, y)), module, AnalogDrums::LT_TUNE_PARAM));
        addParam(createParamCentered<Trimpot>(mm2px(Vec(colParam1, y)), module, AnalogDrums::LT_DECAY_PARAM));
        addParam(createParamCentered<Trimpot>(mm2px(Vec(colParam2, y)), module, AnalogDrums::LT_PITCH_MOD_PARAM));
        addChild(createLightCentered<SmallLight<RedLight>>(mm2px(Vec(colLed, y)), module, AnalogDrums::LT_LIGHT));
        addInput(createInputCentered<PJ301MPort>(mm2px(Vec(colTuneCV, y)), module, AnalogDrums::LT_TUNE_CV_INPUT));
        addOutput(createOutputCentered<PJ301MPort>(mm2px(Vec(colOut, y)), module, AnalogDrums::LT_OUTPUT));

        // === MID TOM (row 3) ===
        y = startY + rowHeight * 3;
        addInput(createInputCentered<PJ301MPort>(mm2px(Vec(colTrigIn, y)), module, AnalogDrums::MT_TRIG_INPUT));
        addParam(createParamCentered<Trimpot>(mm2px(Vec(colTune, y)), module, AnalogDrums::MT_TUNE_PARAM));
        addParam(createParamCentered<Trimpot>(mm2px(Vec(colParam1, y)), module, AnalogDrums::MT_DECAY_PARAM));
        addParam(createParamCentered<Trimpot>(mm2px(Vec(colParam2, y)), module, AnalogDrums::MT_PITCH_MOD_PARAM));
        addChild(createLightCentered<SmallLight<RedLight>>(mm2px(Vec(colLed, y)), module, AnalogDrums::MT_LIGHT));
        addInput(createInputCentered<PJ301MPort>(mm2px(Vec(colTuneCV, y)), module, AnalogDrums::MT_TUNE_CV_INPUT));
        addOutput(createOutputCentered<PJ301MPort>(mm2px(Vec(colOut, y)), module, AnalogDrums::MT_OUTPUT));

        // === HIGH TOM (row 4) ===
        y = startY + rowHeight * 4;
        addInput(createInputCentered<PJ301MPort>(mm2px(Vec(colTrigIn, y)), module, AnalogDrums::HT_TRIG_INPUT));
        addParam(createParamCentered<Trimpot>(mm2px(Vec(colTune, y)), module, AnalogDrums::HT_TUNE_PARAM));
        addParam(createParamCentered<Trimpot>(mm2px(Vec(colParam1, y)), module, AnalogDrums::HT_DECAY_PARAM));
        addParam(createParamCentered<Trimpot>(mm2px(Vec(colParam2, y)), module, AnalogDrums::HT_PITCH_MOD_PARAM));
        addChild(createLightCentered<SmallLight<RedLight>>(mm2px(Vec(colLed, y)), module, AnalogDrums::HT_LIGHT));
        addInput(createInputCentered<PJ301MPort>(mm2px(Vec(colTuneCV, y)), module, AnalogDrums::HT_TUNE_CV_INPUT));
        addOutput(createOutputCentered<PJ301MPort>(mm2px(Vec(colOut, y)), module, AnalogDrums::HT_OUTPUT));

        // === COWBELL (row 5) ===
        y = startY + rowHeight * 5;
        addInput(createInputCentered<PJ301MPort>(mm2px(Vec(colTrigIn, y)), module, AnalogDrums::CB_TRIG_INPUT));
        addParam(createParamCentered<Trimpot>(mm2px(Vec(colTune, y)), module, AnalogDrums::CB_TUNE_PARAM));
        addParam(createParamCentered<Trimpot>(mm2px(Vec(colParam1, y)), module, AnalogDrums::CB_DECAY_PARAM));
        addParam(createParamCentered<Trimpot>(mm2px(Vec(colParam2, y)), module, AnalogDrums::CB_DETUNE_PARAM));
        addChild(createLightCentered<SmallLight<RedLight>>(mm2px(Vec(colLed, y)), module, AnalogDrums::CB_LIGHT));
        addInput(createInputCentered<PJ301MPort>(mm2px(Vec(colTuneCV, y)), module, AnalogDrums::CB_TUNE_CV_INPUT));
        addOutput(createOutputCentered<PJ301MPort>(mm2px(Vec(colOut, y)), module, AnalogDrums::CB_OUTPUT));

        // === CLOSED HAT (row 6) ===
        y = startY + rowHeight * 6;
        addInput(createInputCentered<PJ301MPort>(mm2px(Vec(colTrigIn, y)), module, AnalogDrums::CH_TRIG_INPUT));
        addParam(createParamCentered<Trimpot>(mm2px(Vec(colTune, y)), module, AnalogDrums::CH_TUNE_PARAM));
        addParam(createParamCentered<Trimpot>(mm2px(Vec(colParam1, y)), module, AnalogDrums::CH_DECAY_PARAM));
        addParam(createParamCentered<Trimpot>(mm2px(Vec(colParam2, y)), module, AnalogDrums::CH_SPREAD_PARAM));
        addChild(createLightCentered<SmallLight<RedLight>>(mm2px(Vec(colLed, y)), module, AnalogDrums::CH_LIGHT));
        addInput(createInputCentered<PJ301MPort>(mm2px(Vec(colTuneCV, y)), module, AnalogDrums::CH_TUNE_CV_INPUT));
        addOutput(createOutputCentered<PJ301MPort>(mm2px(Vec(colOut, y)), module, AnalogDrums::CH_OUTPUT));
        addInput(createInputCentered<PJ301MPort>(mm2px(Vec(colParamCV1, y)), module, AnalogDrums::CH_SPREAD_CV_INPUT));

        // === OPEN HAT (row 7) ===
        y = startY + rowHeight * 7;
        addInput(createInputCentered<PJ301MPort>(mm2px(Vec(colTrigIn, y)), module, AnalogDrums::OH_TRIG_INPUT));
        addParam(createParamCentered<Trimpot>(mm2px(Vec(colTune, y)), module, AnalogDrums::OH_TUNE_PARAM));
        addParam(createParamCentered<Trimpot>(mm2px(Vec(colParam1, y)), module, AnalogDrums::OH_DECAY_PARAM));
        addParam(createParamCentered<Trimpot>(mm2px(Vec(colParam2, y)), module, AnalogDrums::OH_SPREAD_PARAM));
        addChild(createLightCentered<SmallLight<RedLight>>(mm2px(Vec(colLed, y)), module, AnalogDrums::OH_LIGHT));
        addInput(createInputCentered<PJ301MPort>(mm2px(Vec(colTuneCV, y)), module, AnalogDrums::OH_TUNE_CV_INPUT));
        addOutput(createOutputCentered<PJ301MPort>(mm2px(Vec(colOut, y)), module, AnalogDrums::OH_OUTPUT));
        addInput(createInputCentered<PJ301MPort>(mm2px(Vec(colParamCV1, y)), module, AnalogDrums::OH_SPREAD_CV_INPUT));

        // === CYMBAL (row 8) ===
        y = startY + rowHeight * 8;
        addInput(createInputCentered<PJ301MPort>(mm2px(Vec(colTrigIn, y)), module, AnalogDrums::CY_TRIG_INPUT));
        addParam(createParamCentered<Trimpot>(mm2px(Vec(colTune, y)), module, AnalogDrums::CY_TUNE_PARAM));
        addParam(createParamCentered<Trimpot>(mm2px(Vec(colParam1, y)), module, AnalogDrums::CY_DECAY_PARAM));
        addParam(createParamCentered<Trimpot>(mm2px(Vec(colParam2, y)), module, AnalogDrums::CY_TONE_PARAM));
        addParam(createParamCentered<Trimpot>(mm2px(Vec(colParam3, y)), module, AnalogDrums::CY_SPREAD_PARAM));
        addChild(createLightCentered<SmallLight<RedLight>>(mm2px(Vec(colLed, y)), module, AnalogDrums::CY_LIGHT));
        addInput(createInputCentered<PJ301MPort>(mm2px(Vec(colTuneCV, y)), module, AnalogDrums::CY_TUNE_CV_INPUT));
        addOutput(createOutputCentered<PJ301MPort>(mm2px(Vec(colOut, y)), module, AnalogDrums::CY_OUTPUT));

        // === CLAP (row 9) ===
        y = startY + rowHeight * 9;
        addInput(createInputCentered<PJ301MPort>(mm2px(Vec(colTrigIn, y)), module, AnalogDrums::CP_TRIG_INPUT));
        addParam(createParamCentered<Trimpot>(mm2px(Vec(colParam1, y)), module, AnalogDrums::CP_REVERB_PARAM));
        addParam(createParamCentered<Trimpot>(mm2px(Vec(colParam2, y)), module, AnalogDrums::CP_SPREAD_PARAM));
        addParam(createParamCentered<Trimpot>(mm2px(Vec(colParam3, y)), module, AnalogDrums::CP_TONE_PARAM));
        addChild(createLightCentered<SmallLight<RedLight>>(mm2px(Vec(colLed, y)), module, AnalogDrums::CP_LIGHT));
        addOutput(createOutputCentered<PJ301MPort>(mm2px(Vec(colOut, y)), module, AnalogDrums::CP_OUTPUT));

        // === MARACAS (row 10) ===
        y = startY + rowHeight * 10;
        addInput(createInputCentered<PJ301MPort>(mm2px(Vec(colTrigIn, y)), module, AnalogDrums::MA_TRIG_INPUT));
        addParam(createParamCentered<Trimpot>(mm2px(Vec(colParam1, y)), module, AnalogDrums::MA_DECAY_PARAM));
        addParam(createParamCentered<Trimpot>(mm2px(Vec(colParam2, y)), module, AnalogDrums::MA_TONE_PARAM));
        addChild(createLightCentered<SmallLight<RedLight>>(mm2px(Vec(colLed, y)), module, AnalogDrums::MA_LIGHT));
        addOutput(createOutputCentered<PJ301MPort>(mm2px(Vec(colOut, y)), module, AnalogDrums::MA_OUTPUT));

        // === RIMSHOT (row 11) ===
        y = startY + rowHeight * 11;
        addInput(createInputCentered<PJ301MPort>(mm2px(Vec(colTrigIn, y)), module, AnalogDrums::RS_TRIG_INPUT));
        addParam(createParamCentered<Trimpot>(mm2px(Vec(colTune, y)), module, AnalogDrums::RS_TUNE_PARAM));
        addParam(createParamCentered<Trimpot>(mm2px(Vec(colParam1, y)), module, AnalogDrums::RS_DECAY_PARAM));
        addChild(createLightCentered<SmallLight<RedLight>>(mm2px(Vec(colLed, y)), module, AnalogDrums::RS_LIGHT));
        addOutput(createOutputCentered<PJ301MPort>(mm2px(Vec(colOut, y)), module, AnalogDrums::RS_OUTPUT));

        // === MASTER SECTION (bottom row) ===
        y = startY + rowHeight * 12 + 2.f;  // Extra spacing for master
        addParam(createParamCentered<RoundBlackKnob>(mm2px(Vec(colTune, y)), module, AnalogDrums::MASTER_COMP_PARAM));
        addParam(createParamCentered<RoundBlackKnob>(mm2px(Vec(colParam1, y)), module, AnalogDrums::MASTER_GAIN_PARAM));
        addParam(createParamCentered<RoundBlackKnob>(mm2px(Vec(colParam2 + 8, y)), module, AnalogDrums::MASTER_TONE_PARAM));
        addOutput(createOutputCentered<PJ301MPort>(mm2px(Vec(colOut, y)), module, AnalogDrums::MIX_OUTPUT));

        // Circuit bend params at bottom right
        addParam(createParamCentered<Trimpot>(mm2px(Vec(colParamCV1, y)), module, AnalogDrums::BD_DRIVE_PARAM));
        addParam(createParamCentered<Trimpot>(mm2px(Vec(colParamCV2, y)), module, AnalogDrums::SD_SNAP_FILTER_PARAM));
    }
};

} // namespace WiggleRoom

Model* modelAnalogDrums = createModel<WiggleRoom::AnalogDrums, WiggleRoom::AnalogDrumsWidget>("AnalogDrums");

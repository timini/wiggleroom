/******************************************************************************
 * MOOG LPF
 * Classic Moog ladder lowpass filter with resonance
...
#include "moog_lpf.hpp"  // Generated by Faust from moog_lpf.dsp
...
/**
 * MoogLPF - Moog Ladder Lowpass Filter
 *
 * A classic 4-pole resonant lowpass filter based on the Moog synthesizer.
 ...
 */
struct MoogLPF : FaustModule<VCVRackDSP> {
    enum ParamId {
        CUTOFF_PARAM,
        RESONANCE_PARAM,
        PARAMS_LEN
...
struct MoogLPFWidget : ModuleWidget {
    MoogLPFWidget(MoogLPF* module) {
        setModule(module);
        setPanel(createPanel(asset::plugin(pluginInstance, "res/MoogLPF.svg")));
        ...
        addParam(createParamCentered<RoundBigBlackKnob>(
            Vec(xCenter, 70), module, MoogLPF::CUTOFF_PARAM));

        // Resonance knob
        addParam(createParamCentered<RoundBlackKnob>(
            Vec(xCenter, 140), module, MoogLPF::RESONANCE_PARAM));

        // CV Inputs
        addInput(createInputCentered<PJ301MPort>(
            Vec(xCenter - 25, 200), module, MoogLPF::CUTOFF_CV_INPUT));
        addInput(createInputCentered<PJ301MPort>(
            Vec(xCenter + 25, 200), module, MoogLPF::RESONANCE_CV_INPUT));

        // Audio I/O
        addInput(createInputCentered<PJ301MPort>(
            Vec(xCenter - 25, 280), module, MoogLPF::AUDIO_INPUT));
        addOutput(createOutputCentered<PJ301MPort>(
            Vec(xCenter + 25, 280), module, MoogLPF::AUDIO_OUTPUT));
    }
};

} // namespace WiggleRoom

Model* modelMoogLPF = createModel<WiggleRoom::MoogLPF, WiggleRoom::MoogLPFWidget>("MoogLPF");

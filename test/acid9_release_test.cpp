...
int main(int argc,char**argv){
 ...
 rack::Plugin plugin;plugin.slug="WiggleRoom";plugin.version="2.1.3";plugin.addModel(modelACID9Voice);pluginInstance=&plugin;rack::plugin::plugins.push_back(&plugin);

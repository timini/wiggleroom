...
Coordinates the Faust module development loop:
1. Verifier builds and tests
2. Judge evaluates results
3. If issues: generate fix instructions for Faust Dev Agent
4. Track iterations and progress
5. Decide when to stop (success or max iterations)

The Faust Dev Agent is implemented by Claude Code itself - this orchestrator
provides structured instructions that Claude can execute.
"""

...
for s,x,y,z in [('OSCILLATOR',85,56,8),('FILTER',255,56,8),('DELAY',425,56,8),('SINE / SQUARE',125,178,6.5),('ACID / LEAD',295,234,6.5),('/4   /2   ×1   ×2   ×4',425,234,6.5)]:labels+=text(s,x,y,z,'#b8d8e1')
...
print('PASS: 29 controls, labels, mode legends, indicator and branding clearances.')

...
MODULE_HP = {
    ...
    "TriPhaseEnsemble": 4,
    "Linkage": 6,
    # 2- and 3-channel EucLogic chain. Widths come from the HP constants in
    # src/common/euclogic/*Core.hpp, not from the panel files: the panels
    # currently shipped for these are all 40HP copies of the old Euclogic art.
    "EucSeq2": 20,
    "EucSeq3": 20,
    "LogicMangler2": 8,
    "LogicMangler3": 10,
